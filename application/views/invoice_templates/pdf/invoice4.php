...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/usr/share/nginx/html/assets/invoices/assets/css/invoice-4.css">
</head>
<body>
    <div class="wrapper two-columns">
        ...
        <div align="right">
            <div id="qr-code">
                <?php
                    echo getQrCode($qr_code_file_path);
                ?>
            </div>
        </div>
    </div>
    ...
    <?php $totaltudo = $total_vat_eur + $total_without_vat; ?>
    <?php $totaltudoconvertio = number_format((float)$totaltudo, 2, '.', ''); ?>
    <p id="amount-in-words">
        <b><?= lang('amount_in_words'); ?>:</b> <?php $f = new NumberFormatter("en", NumberFormatter::SPELLOUT); echo ucwords($f->format($total_vat_eur + $total_without_vat)); ?>
    </p>
