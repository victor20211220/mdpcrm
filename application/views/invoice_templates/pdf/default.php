...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/usr/share/nginx/html/assets/invoices/assets/css/invoice-1.css">
</head>
<body>
    ...
    <div id="details" class="wrapper two-columns">
        <div style="max-width: 75% !important;">
            ...
            <div class="details">
                ...
                <div><span><?= lang('invoice_code'); ?>:</span> <?= $invoice->company_code; ?></div>
                <div><span><?= lang('invoice_vat'); ?>:</span> <?= $invoice->company_vatregnumber; ?></div>
        ...
        <div style="max-width: 75% !important;">
            ...
            <div class="details">
                ...
                <div style="white-space: nowrap !important;"><span><?= lang('address'); ?>:</span> <?= $invoice->client_address_1; ?></div>
                <div><span><?= lang('invoice_code'); ?>:</span><?= ($invoice->client_city) ? $invoice->client_reg_number : ''; ?></div>
                <div><span><?= lang('invoice_vat'); ?>:</span><?= ($invoice->client_state) ? $invoice->client_vat_id : ''; ?></div>
    ...
    <p id="amount-in-words">
        ...
        <?php
            ...
            echo ucwords($f->format($total_vat_eur + $total_without_vat));
        ?>
    </p>
