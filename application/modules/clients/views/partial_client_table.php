                    ...
                    <div class="table-responsive">
                        <table ui-jq="dataTable" class="table table-striped m-b-none dataTable no-footer"
                            ...
                            <tr role="row">
                                ...
                                <th width="10%" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                    colspan="1"
                                    aria-label="CSS grade: activate to sort column ascending">
                                    <?= lang('options'); ?>
                                </th>
                            ...
                            <?php foreach ($records as $client): ?>
                                ...
                                <tr role="row" class="<?= $class; ?>">
                                    <td class="sorting_1">
                                        <?= anchor('clients/view/' . $client->client_id, $client->client_name); ?>
                                    </td>
                                    <td>
                                        <?= $client->client_email; ?>
                                    </td>
                                    <td>
                                        <?=
                                            $client->client_phone ?
                                                $client->client_phone :
                                                ($client->client_mobile ? $client->client_mobile : '');
                                        ?>
                                    </td>
                                    ...
                                    <td>
                                        <?= ($client->client_active) ? lang('yes') : lang('no'); ?>
                                    </td>
                                    <td>
                                        <div class="options btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="<?= site_url('clients/view/' . $client->client_id); ?>">
                                                        <i class="fa fa-eye fa-margin"></i> <?= lang('view'); ?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="<?= site_url('clients/form/' . $client->client_id); ?>">
                                                ...
                                                <li>
                                                    <a href="<?= site_url('clients/delete/' . $client->client_id); ?>"
