            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-xs-12 col-sm-2 text-right text-left-xs">
                        <label for="invoice_id" class="control-label"><?= lang('select_sepa_xml'); ?></label>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        <a href="<?= site_url('payments/select'); ?>" id="btn-cancel" name="btn_cancel"
                           class="btn btn-default" value="1"><?= lang('cancel'); ?></a>
                        <button type="submit" id="btn-submit" name="btn_submit_1" class="btn btn-success"
                                value="1"><?= lang('next_step'); ?></button>
                    </div>
                </div>
            </div>
        </div>
