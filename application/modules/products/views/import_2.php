...
<div class="bg-light lter b-b wrapper-md">
    <h1 class="m-n font-thin h3"><?= lang('import_products'); ?></h1>
</div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php } else { ?>
                    ...
                    <div class="row">
                        <div class="panel-heading font-bold">
                            1: Please order your import fields so they match your database
                        </div>
                        <br>
                        <div class="panel-heading ">
                            * You can delete useless import columns by using the X icon next to the field name.<br>
                            * In case of deletion by mistake, feel free to restart the import proccess using the
                            "Restart"
                    ...
                    <div class="row">
                        <div class="panel-heading font-bold">
                            2: Preview (only first 30 rows will appear here)
                        </div>
                        </br>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
                            <div class="wrapper bg-white but-wrapper">
                                <button type="submit" id="btn-cancel" name="btn_cancel" class="btn btn-default"
                                        value="1"><i
                                            class="fa fa-times"></i> Restart proccess
                                </button>
                                <button type="submit" id="btn-submit" name="btn_submit_2" class="btn btn-info"
                                        value="1"><i
                                            class="fa fa-check"></i> Add to database
                                </button>
                            </div>
                        </div>
                    </div>
