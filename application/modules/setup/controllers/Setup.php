...
class Setup extends MX_Controller
{
    ...
    {
        if ($this->input->post('btn_continue', true))
        {
    ...
    public function configure_database()
    {
        ...
        {
            $this->write_database_config($this->input->post('db_hostname', true), $this->input->post('db_username', true), $this->input->post('db_password', true), $this->input->post('db_database', true));
        }
