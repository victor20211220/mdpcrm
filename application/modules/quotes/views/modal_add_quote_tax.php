...
<div id="add-quote-tax" class="modal col-xs-12 col-sm-10 col-sm-offset-1 col-md-6 col-md-offset-3"
    ...
    <form class="modal-content">
        ...
        <div class="modal-footer">
            <div class="btn-group">
                ...
                <button class="btn btn-success padder" id="quote_tax_submit" type="button">
