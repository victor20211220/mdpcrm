<script type="text/javascript">
    ...
    window.onload = function () {
        ...
        // Get the latest version from updates.mdpcrm.com
        $.getJSON("https://ids.mdpcrm.com/updatecheck", function (data) {
        ...
        // Get the latest news
        $.getJSON("https://ids.mdpcrm.com/get_news", function (data) {
            //console.log(data);
            setTimeout(function () {
...
<div class="tab-info">
    ...
    <div id="updatecheck-results">
        ...
        <span id="updatecheck-failed" class="btn btn-default btn-sm disabled hidden">
            <?php echo lang('updatecheck_failed'); ?>
        </span>

        <a href="https://mdpcrm.com/downloads" id="updatecheck-updates-available"
    ...
    <h4><?php echo lang('mdpcrm_news'); ?></h4>
