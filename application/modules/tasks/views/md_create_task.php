<script type="text/javascript">
            ...
            $.post("<?php echo site_url('tasks/ajax/create'); ?>", {
                ...
                function (data) {
                    ...
                    if (response.success == '1') {
                        ...
                        $( "#otherModal" ).fadeOut( "slow", function() {
                        $('#otherModal').hide();
                      });

                        $('.modal-backdrop').remove();
                        $('#modal-createtask').click();
                      document.getElementById('sweet_modal').contentWindow.location.reload();
	...
	<div class="modal-dialog" id="otherModal">
		<div class="modal-content">
			<form class="modal-content">

        <div class="modal-header">

            <a id="dismissModal" class="close"><i class="fa fa-close"></i></a>



            <h3><?php echo lang('create_task'); ?></h3>
        ...
        <div class="modal-footer">
                ...
                <button class="btn btn-default" type="button" id="dismissModalz">

                    <i class="fa fa-times"></i> <?php echo lang('cancel'); ?>

                </button>

                <button class="btn btn-success ajax-loader" id="task_create_confirm" type="button">
