            ...
            $("[name='supplier_name']").on("select2-selecting", function (e) {
                if (e.choice.supplier_vat_id == undefined) {
                    ...
                    if (e.choice.supplier_address_1 == '') {
                        $('#supplier_address_1').val(e.choice.supplier_address_1).prop('disabled', false).attr("placeholder", "Type value here");
                    } else {
                        $('#supplier_address_1').val(e.choice.supplier_address_1).prop('disabled', true).attr("placeholder", "");
                    }

                    if (e.choice.supplier_vat_id == '') {
                        $('#supplier_vat_id').val(e.choice.supplier_vat_id).prop('disabled', false).attr("placeholder", "Type value here");
                    } else {
                        $('#supplier_vat_id').val(e.choice.supplier_vat_id).prop('disabled', true).attr("placeholder", "");
                    }
                }
            });
...
<div id="create-invoice" class="modal col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2"
    ...
    <form class="modal-content">
        ...
        <div class="modal-body row">
            ...
            <input class="hidden" name='supplier_id' id="supplier_id" <?php if ($supplier_id) { echo 'value="' . html_escape($supplier_id) . '"'; } ?>>
            <input class="hidden" id="payment_method_id" value="<?= $this->Mdl_settings->setting('invoice_default_payment_method'); ?>">
            <div class="col-md-6">
