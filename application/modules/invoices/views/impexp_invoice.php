...
<div class="bg-light lter b-b wrapper-md">
    <h1 class="m-n font-thin h3"><?php echo lang('export_invoices'); ?></h1>
</div>

<div class="">
    <div class="panel panel-default">
        <div class="panel-body">
            <div id="report_options" class="">
                    ...
                    <form method="post" target="_blank">
                        <div class='row'>
                            <div class='col-sm-4'>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        <input id="from_date" name="from_date" class="form-control datepicker" value="<?php echo date('m/d/Y', time()); ?>">
                            ...
                            <div class='col-sm-4'>
                                <div class="form-group has-feedback">
                                    ...
                                    <div class="input-group">
                                        <input id="to_date" name="to_date" class="form-control datepicker" value="<?php echo date('m/d/Y', time()); ?>">
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="input-group">
                                <div class="checkbox">
                                    <label class="i-checks">
                                        <input type="checkbox" id="additional_options" name="additional_options"
                                               value="1">
                                        <i></i>
                                        <?php echo lang('cust_fields_ord'); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="add_opts_div">
                            <div class="table-responsive">
                                ...
                                <ul id="sortable" class="list-group gutter list-group-lg list-group-sp">
                                    <?php
                                    foreach ($mysql_cols as $k => $mysql_row) { ?>
                                        <li id='<?php echo $k; ?>' class="list-group-item bg-info">
										      <span class="pull-right">
										        <a href='' title='Remove this field from export file'
                                                   class='rem_this_col'><i class="fa fa-check-square"></i></a>
										      </span>
                                            <span class="pull-left"><i class="fa fa-arrows"></i>&nbsp;&nbsp;</span>
                                            <div class="clear">
                                                <?php echo $mysql_row['name'] . ' (' . $mysql_row['type'] . ')'; ?>
                                            </div>
                                        </li>
                                    <?php } ?>
                                </ul>
                        ...
                        <div class="form-group has-feedback">
                            <label for="to_date">
                                <?php echo lang('export_type'); ?>
                            </label>

                            <div class="input-group">
                                <div class="radio">
                                    <label class="i-checks">
                                        <input type="radio" checked name="export_type" value="excel">
                                        <i></i>
                                ...
                                <div class="radio">
                                    <label class="i-checks">
                                        <input type="radio" name="export_type" value="raw_xml">
                                        <i></i>
                                        <?php echo lang('export_xml'); ?>

                                    </label>
                                </div>
                                <div class="radio">
                                    <label class="i-checks">
                                        <input type="radio" name="export_type" id='zip_id' value="zip">
                                        <i></i>
                                        <?php echo lang('export_zip'); ?>

                                    </label>
                                </div>
                                <div class="radio">
                                    <label class="i-checks">
                                        <input type="radio" name="export_type" id='xml_id' value="xml">
                                        <i></i>
                                        <?php echo lang('export_e_invoice'); ?>
                                    </label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <input type="submit" class="btn btn-success" name="btn_export" value="<?php echo lang('export_button'); ?>">
                        </div>
                    </form>
                </div>
            </div>
