...
<div id="modal-create-credit-invoice" class="modal col-xs-12 col-sm-10 col-sm-offset-1 col-md-4 col-md-offset-4"
 ...
 ?>>
        ...
        <div class="modal-footer">
            <div class="btn-group">
                ...
                <button class="btn btn-success padder" id="create-credit-confirm" type="button">
