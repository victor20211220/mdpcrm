...
$lang = [
    ...
    'bcc_mails_to_admin_hint'                      => 'Le compte admin est le compte qui a été créé lors de l\'installation mdpcrm.',
    ...
    'mdpcrm_news'                                  => 'Les dernières nouvelles de mdpcrm',
    'menu'                                         => 'Menu',
    ...
    'password_reset_email'                         => 'Vous avez demandé un nouveau mot de passe pour votre Installation d\'mdpcrm. Veuillez cliquer sur le lien ci-dessous pour réinitialiser votre mot de passe :',
    ...
    'php_version_fail'                             => 'La version PHP %s est installée mais mdpcrm requiert la version PHP %s ou supérieure',
    'php_version_success'                          => 'PHP semble répondre aux besoins de l\'installation',
    'please_enable_js'                             => 'Merci de rendre possible l\'exécution de code javascript pour le bon fonctionnement d\'mdpcrm',
    'prefix'                                       => 'Prefixe ',
    'prev'                                         => 'Préc',
    ...
    'quote_status_email_body'                      => 'Le client %1$s a %2$s le devis %3$s. Lien vers le devis: %4$s',
    ...
    'setup_complete_message'                       => 'mdpcrm est bien installé. Vous pouvez dés à présent vous connecter.',
    ...
    'setup_complete_support_note'                  => 'Si vous rencontrez un problème ou avez besoin d\'aide, consultez le <a href="https://wiki.mdpcrm.com">wiki officiel</a> ou le <a href="https://community.mdpcrm.com/">forum de la communauté</a>.',
    'setup_create_user'                            => 'Création d\'un compte utilisateur',
    'setup_create_user_message'                    => 'Voici les informations nécessaires pour vous connecter à mdpcrm.',
    ...
    'setup_db_database_info'                       => 'Le nom de votre base de données pour mdpcrm.',
    ...
    'setup_prerequisites_message'                  => 'Bienvenue dans mdpcrm ! Tous les points suivants doivent être résolus afin de pouvoir poursuivre le programme d\'installation.',
    ...
    'setup_user_email_info'                        => 'Votre adresse de courriel servira pour se connecter à mdpcrm.',
    ...
    'setup_v120_alert'                             => '<b>Attention!</b> <br/>Il est extrêmement recommandé que vous lisiez <a href="https://go.mdpcrm.com/v120update" target="_blank">cet avis de mise à jour</a> concernant certains changements importants dans l\'application mdpcrm.',
